...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnButtonClick))]
    public struct OnButtonClickNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnButtonClickMessageListener);
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnButtonClick, Target);
        }
