...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnCancel))]
    public struct OnCancelNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.BaseEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnCancelMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.BaseEventData>(nodeId, this, EventHooks.OnCancel, Target);
        }
