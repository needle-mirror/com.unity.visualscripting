...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnDrag))]
    public struct OnDragNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.PointerEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnDragMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.PointerEventData>(nodeId, this, EventHooks.OnDrag, Target);
        }
