...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnEndDrag))]
    public struct OnEndDragNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.PointerEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnEndDragMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.PointerEventData>(nodeId, this, EventHooks.OnEndDrag, Target);
        }
