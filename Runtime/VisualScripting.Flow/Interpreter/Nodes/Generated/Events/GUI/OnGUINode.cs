...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnGUI))]
    public struct OnGUINode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnGUI, default);
        }
