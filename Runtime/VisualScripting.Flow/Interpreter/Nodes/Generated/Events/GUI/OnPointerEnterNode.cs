...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnPointerEnter))]
    public struct OnPointerEnterNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.PointerEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnPointerEnterMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.PointerEventData>(nodeId, this, EventHooks.OnPointerEnter, Target);
        }
