...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnPointerExit))]
    public struct OnPointerExitNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.PointerEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnPointerExitMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.PointerEventData>(nodeId, this, EventHooks.OnPointerExit, Target);
        }
