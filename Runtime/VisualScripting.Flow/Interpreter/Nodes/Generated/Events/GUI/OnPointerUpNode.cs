...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnPointerUp))]
    public struct OnPointerUpNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.PointerEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnPointerUpMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.PointerEventData>(nodeId, this, EventHooks.OnPointerUp, Target);
        }
