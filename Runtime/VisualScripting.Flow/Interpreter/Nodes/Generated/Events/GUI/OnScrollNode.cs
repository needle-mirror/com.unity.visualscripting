...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnScroll))]
    public struct OnScrollNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.PointerEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnScrollMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.PointerEventData>(nodeId, this, EventHooks.OnScroll, Target);
        }
