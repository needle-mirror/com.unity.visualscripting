...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnSelect))]
    public struct OnSelectNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.BaseEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnSelectMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.BaseEventData>(nodeId, this, EventHooks.OnSelect, Target);
        }
