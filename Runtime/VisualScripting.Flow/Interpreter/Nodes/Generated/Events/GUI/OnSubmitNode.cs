...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnSubmit))]
    public struct OnSubmitNode : IEntryPointRegisteredNode<UnityEngine.EventSystems.BaseEventData>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnSubmitMessageListener);
        ...
        {
            ctx.RegisterEventHandler<UnityEngine.EventSystems.BaseEventData>(nodeId, this, EventHooks.OnSubmit, Target);
        }
