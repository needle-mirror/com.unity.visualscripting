...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnMouseDown))]
    public struct OnMouseDownNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnMouseDownMessageListener);
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnMouseDown, Target);
        }
