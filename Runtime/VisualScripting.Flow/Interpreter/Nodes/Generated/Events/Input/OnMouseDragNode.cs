...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnMouseDrag))]
    public struct OnMouseDragNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnMouseDragMessageListener);
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnMouseDrag, Target);
        }
