...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnMouseInput))]
    public struct OnMouseInputNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        public OutputTriggerPort Trigger;
        public InputDataPort Button;
