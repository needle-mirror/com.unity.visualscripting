...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnMouseOver))]
    public struct OnMouseOverNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnMouseOverMessageListener);
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnMouseOver, Target);
        }
