...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnMouseUp))]
    public struct OnMouseUpNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        public Type MessageListenerType => typeof(Unity.VisualScripting.UnityOnMouseUpMessageListener);
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnMouseUp, Target);
        }
