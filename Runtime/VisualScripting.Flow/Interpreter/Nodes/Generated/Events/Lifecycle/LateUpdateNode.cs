...
{
    [NodeDescription(typeof(Unity.VisualScripting.LateUpdate))]
    public struct LateUpdateNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.LateUpdate, default);
        }
