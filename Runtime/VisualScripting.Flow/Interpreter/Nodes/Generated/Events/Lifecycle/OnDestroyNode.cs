...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnDestroy))]
    public struct OnDestroyNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnDestroy, default);
        }
