...
{
    [NodeDescription(typeof(Unity.VisualScripting.OnEnable))]
    public struct OnEnableNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.OnEnable, default);
        }
