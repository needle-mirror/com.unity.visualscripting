...
{
    [NodeDescription(typeof(Unity.VisualScripting.Start))]
    public struct StartNode : IEntryPointRegisteredNode<EmptyEventArgs>
    {
        ...
        {
            ctx.RegisterEventHandler<Unity.VisualScripting.EmptyEventArgs>(nodeId, this, EventHooks.Start, default);
        }
